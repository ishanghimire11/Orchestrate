...
import { fetchAllEvents, getAllEvents } from "@/lib/actions/event.action";
import EventCollection from "@/components/shared/Collection/EventCollection";
...
const Home = async () => {
  ...
  return (
    <div>
      ...
      {/* Events List */}
      <EventCollection data={events?.data} totalPage={events?.totalPages} />;
    </div>
  );
};
